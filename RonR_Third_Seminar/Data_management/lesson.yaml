...
- Class: text
  Output: Hello and welcome to the second lesson of the 3rd RonR! Seminar. In this lesson we're gonna cover
        some basic data manipulation tricks like creating, renaming and recoding variables. In addition,
...
- Class: text
  Output: Let's divide the problem into two. First, the last column of the asfr7512 is empty,
...
- Class: mult_question
  ...
  CorrectAnswer: any_of_exprs("asfr[,2:ncol(asfr)] <- asfr[,2:ncol(asfr)]/1000", "asfr[2:ncol(asfr)] <- asfr[2:ncol(asfr)]/1000")
  AnswerTests: any_of_exprs("asfr[,2:ncol(asfr)] <- asfr[,2:ncol(asfr)]/1000", "asfr[2:ncol(asfr)] <- asfr[2:ncol(asfr)]/1000")
